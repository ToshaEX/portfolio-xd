          ...
          <div className='relative col-span-12 space-y-6 px-4 sm:col-span-9'>
            {experienceData.map((data, i) => (
              <div key={data.company + i}>
                ...
                <div className='relative col-span-12 space-y-12 px-4 before:absolute before:-left-3 before:bottom-0 before:top-2 before:w-0.5 before:bg-gray-700 sm:col-span-8 sm:space-y-8'>
